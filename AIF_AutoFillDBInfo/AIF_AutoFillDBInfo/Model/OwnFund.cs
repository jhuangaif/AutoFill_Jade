...
{
    public class OwnFund : NotifyBase
    {
        ...
        public OwnFund()
        {
            ...
            //_accountType = "";
            //_investmentTo = "";
            _payMethod = ""; //personal cheque, void cheque, direct deposit
            _invInstruction = "";//One-time PAD, Regular PAD
            _onetimePADdate = "";
            //_accountNo = "";
            //_transitNo = "";
            //_institutionNo = "";
        ...
        private Cheque _ofCheque;
        public Cheque OFCheque
        {
            get { return _ofCheque; }
            set
            {
                _ofCheque = value;
                OnPropertyChanged("OFCheque");
            }
